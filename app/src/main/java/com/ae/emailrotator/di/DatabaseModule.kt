...
object DatabaseModule {
    ...
    @Provides fun provideToolEmailDao(db: AppDatabase): ToolEmailDao = db.toolEmailDao()
    @Provides fun provideUsageHistoryDao(db: AppDatabase): UsageHistoryDao = db.usageHistoryDao()
}